 ...
 */
    ...
    , function(e, t) {
        e.exports = {
            ...
            mail: "メールアドレス",
            link: "サイト(http://)",
            nickFail: "3バイト以上@ニックネームをご入力ください.",
            ...
            "code-98": "ロードエラーです。av-min.js @バージョンを確認してください.",
            "code-99": "ロードエラーです。initにある`el`エレメントを確認ください.",
            "code-100": "ロードエラーです。AppIdとAppKeyを確認ください.",
            "code-140": "今日@APIコール@総数が開発バージョン@上限を超えた.",
            "code-401": "権限が制限されています。AppIdとAppKeyを確認ください.",
            "code-403": "アクセスがAPIなどに制限されました、ドメイン名@セキュリティ設定を確認ください"
        }
    }
    , function(e, t) {
        e.exports = {
